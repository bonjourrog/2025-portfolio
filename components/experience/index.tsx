import { Experience as experienceEntity } from "@/entity/experience";
import { EXPERIENCE_DATA_MOCK } from "@/mocks/data/experience";

export default function Experience() {
    const experiences: experienceEntity[] = EXPERIENCE_DATA_MOCK;
    return (
        <section id="experience" className="py-16 sm:py-24">
            ...
            <div className="space-y-12">
                {experiences.map((exp) => (
                    <div
                        key={exp.id}
                        className="border-l-2 border-gray-900 pl-6 sm:pl-8 relative"
                    >
