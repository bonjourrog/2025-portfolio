    ...
    return (
        <section id="hero" className="flex flex-col justify-center py-32 min-h-screen">
            ...
            <p className="text-zinc-600 max-w-[600px] mb-8 font-normal" style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)'}}>
                Especializado en crear experiencias web modernas, escalables y elegantes. Con experiencia en Angular, React, Next.js y herramientas modernas del ecosistema web.
            </p>
            <a
                href="#projects"
                onClick={(e) => {
