...
import { skillsData, translations } from "@/mocks/data/translation";

export default function Skills() {
    const { lang } = useLang();
    const t = translations[lang].skills;
    const skillCategories = skillsData[lang];
                    ...
                    >
                        ...
                        <ul className="space-y-2">
                            {category.skills.map((skill, idx) => (
                                <li key={idx} className="py-2 text-gray-500 text-sm sm:text-base flex items-center">
